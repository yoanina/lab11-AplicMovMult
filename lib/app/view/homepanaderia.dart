...
import 'package:laboratorio02/app/view/otherpanaderia.dart';

class HomepanaderiaPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFFFACEC0),
        title: Text('Nuestros Panes y mas'),
      ),
      body: Stack(
        children: [
          Positioned(
        ...
        children: [
          ...
          const SizedBox(height: 1),
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => OtherpanaderiaPage()),
                    );
                    },
                    child: Text('Panes integrales'),
                    style: ButtonStyle(
          ...
          const SizedBox(height: 1),
                  ElevatedButton(
                    ...
                    child: const Text('Donas Caseras'),
                    style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(204, 187, 176, 133)),
                    foregroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(186, 0, 0, 0)),
                  ),
